          ...
          >
            ...
            <tr>
              ...
              <td rowSpan="2" style={{ width: "50%", height: "500px", textAlign: "left" }}>
                <div style={{ position: "absolute", marginLeft: "490px", cursor: "pointer" }}>
                  <ContentCopyIcon />
                </div>
                <div>{`{`}</div>
                <div style={{ paddingLeft: "16px" }}>"Version": "2012-10-17",</div>
  ...
  return (
    <div style={{ display: "flex" }}>
      <div style={{ width: "120px", marginTop: "90px", border: "3px solid black", marginRight: "10px" }}>
        ...
        <div>
          <div style={{ fontSize: "13px", borderBottom: "3px solid black", padding: "5px 10px", backgroundColor: tab === 0 ? "#D3D3D3" : "#FFFFFF" }} onClick={handleTabClick(0)}>
            권고사항 1
          </div>
          <div style={{ fontSize: "13px", borderBottom: "3px solid black", padding: "5px 10px", backgroundColor: tab === 1 ? "#D3D3D3" : "#FFFFFF" }} onClick={handleTabClick(1)}>
            권고사항 2
          </div>
          <div style={{ fontSize: "13px", borderBottom: "3px solid black", padding: "5px 10px", backgroundColor: tab === 2 ? "#D3D3D3" : "#FFFFFF" }} onClick={handleTabClick(2)}>
            권고사항 3
          </div>
          <div style={{ fontSize: "13px", borderBottom: "3px solid black", padding: "5px 10px", backgroundColor: tab === 3 ? "#D3D3D3" : "#FFFFFF" }} onClick={handleTabClick(3)}>
            권고사항 4
          </div>
          <div style={{ fontSize: "13px", borderBottom: "3px solid black", padding: "5px 10px", backgroundColor: tab === 4 ? "#D3D3D3" : "#FFFFFF" }} onClick={handleTabClick(4)}>
            권고사항 5
          </div>
          <div style={{ fontSize: "13px", borderBottom: "3px solid black", padding: "5px 10px", backgroundColor: tab === 5 ? "#D3D3D3" : "#FFFFFF" }} onClick={handleTabClick(5)}>
            권고사항 6
          </div>
          <div style={{ fontSize: "13px", borderBottom: "3px solid black", padding: "5px 10px", backgroundColor: tab === 6 ? "#D3D3D3" : "#FFFFFF" }} onClick={handleTabClick(6)}>
            권고사항 7
          </div>
        </div>
      </div>
